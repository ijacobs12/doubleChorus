/*
  ==============================================================================
    ...
    https://github.com/marcwilhite/StereoChorus/blob/master/Source/FractionalDelayBuffer.cpp
  ==============================================================================
*/
...
float FractionalDelayBuffer::getSample(float sampleIndex)
{
    ...
    if (localIndex >= bufferSize) localIndex -= bufferSize;
    if (localIndex < 0) localIndex += bufferSize;
...
{
    int lower = bufferPosition;
    int upper = (lower + 1) % bufferSize;
